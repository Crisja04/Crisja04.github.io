...
if (! function_exists('mfn_styles')) {
	function mfn_styles()
	{
		...
		if ($_GET && key_exists('mfn-rtl', $_GET)) {
			wp_enqueue_style('mfn-rtl', get_theme_file_uri('/rtl.css'), false, MFN_THEME_VERSION);
		}
		...
		if (mfn_opts_get('static-css') && (! ($_GET && key_exists('mfn-c', $_GET)))) {
			...
			wp_enqueue_style('mfn-style-static', get_theme_file_uri('/style-static.css'), false, MFN_THEME_VERSION);
